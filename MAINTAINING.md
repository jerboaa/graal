...
2. Once the pull request is merged, create two new tags as follows:
   ```bash
   git tag -s vm-<version> -m "Community source release of GraalVM <version>"
   git tag -s jdk-<jdk-version> -m "Community source release of GraalVM <version>"
   ```
...
* [Karm Babacek](https://github.com/Karm/) (Lead maintainer)
